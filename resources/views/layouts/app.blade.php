...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{url('public/adminmart')}}/assets/images/favicon.png">
    <title>Adminmart Template - The Ultimate Multipurpose admin template</title>
    <!-- Custom CSS -->
    <link href="{{url('public/adminmart')}}/assets/extra-libs/c3/c3.min.css" rel="stylesheet">
    <link href="{{url('public/adminmart')}}/assets/libs/chartist/dist/chartist.min.css" rel="stylesheet">
    <link href="{{url('public/adminmart')}}/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
    <!-- Custom CSS -->
...
<body>
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="{{url('public/adminmart')}}/assets/images/logo-icon.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img src="{{url('public/adminmart')}}/assets/images/logo-icon.png" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="{{url('public/adminmart')}}/assets/images/logo-text.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo text -->
                                <img src="{{url('public/adminmart')}}/assets/images/logo-light-text.png" class="light-logo" alt="homepage" />
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="{{url('public/adminmart')}}/assets/images/users/profile-pic.jpg" alt="user" class="rounded-circle"
                                    width="40">
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{url('public/adminmart')}}/assets/libs/jquery/dist/jquery.min.js"></script>
    <script src="{{url('public/adminmart')}}/assets/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="{{url('public/adminmart')}}/assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js"></script>
    <!-- apps -->
    <!-- apps -->
    <script src="{{url('public/adminmart')}}/dist/js/app-style-switcher.js"></script>
    <script src="{{url('public/adminmart')}}/dist/js/feather.min.js"></script>
    <script src="{{url('public/adminmart')}}/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="{{url('public/adminmart')}}/dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="{{url('public/adminmart')}}/dist/js/custom.min.js"></script>
    ...
    <script src="{{url('public/adminmart')}}/assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js"></script>
    <script src="{{url('public/adminmart')}}/dist/js/pages/dashboards/dashboard1.min.js"></script>
